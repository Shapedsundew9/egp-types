...
class end_point_ref(generic_end_point):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return self.row == other.row and self.idx == other.idx if isinstance(other, end_point_ref) else False
...
class dst_end_point_ref(end_point_ref):
    ...
    row: DestinationRow  # type: ignore [reportIncompatibleVariableOverride]
...
class src_end_point_ref(end_point_ref):
    ...
    row: SourceRow  # type: ignore [reportIncompatibleVariableOverride]
...
class dst_end_point(end_point):
    ...
    refs: list[src_end_point_ref] = field(default_factory=list)  # type: ignore [reportIncompatibleVariableOverride]
...
class src_end_point(end_point):
    ...
    refs: list[dst_end_point_ref] = field(default_factory=list)  # type: ignore [reportIncompatibleVariableOverride]
